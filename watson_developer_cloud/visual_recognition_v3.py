...
a custom classifier to identify subjects that suit your needs.   **Tip:** To test calls to
the **Custom classifiers** methods with the API explorer, provide your `api_key` from your
...
class VisualRecognitionV3(WatsonService):
    ...
    def classify(self, images_file=None, parameters=None, accept_language=None, images_file_content_type=None, images_filename=None):
        """
        Classify images.
    ...
    def detect_faces(self, images_file=None, parameters=None, images_file_content_type=None, images_filename=None):
        """
        ...
        :param str parameters: A string representation of a JSON object that specifies a single image to analyze by URL. The parameter can be sent as a string or a file.  Example: `{\"url\":\"http://www.example.com/images/myimage.jpg\"}`.
        :param str images_file_content_type: The content type of images_file.
        :param str images_filename: The filename for images_file.
    ...
    def create_classifier(self, name, classname_positive_examples, negative_examples=None, classname_positive_examples_filename=None, negative_examples_filename=None):
        """
        Create a classifier.
        ...
        if not classname_positive_examples_filename and hasattr(classname_positive_examples, 'name'):
            classname_positive_examples_filename = classname_positive_examples.name
        mime_type = 'application/octet-stream'
        classname_positive_examples_tuple = (classname_positive_examples_filename, classname_positive_examples, mime_type)
        ...
        if negative_examples:
            ...
            mime_type = 'application/octet-stream'
            negative_examples_tuple = (negative_examples_filename, negative_examples, mime_type)
        url='/v3/classifiers'
        response = self.request(method='POST',
            url=url,
            params=params,
            files={ 'name': name_tuple, 
            'classname_positive_examples': classname_positive_examples_tuple, 
    ...
    def update_classifier(self, classifier_id, classname_positive_examples=None, negative_examples=None, classname_positive_examples_filename=None, negative_examples_filename=None):
        """
        Update a classifier.
        ...
        response = self.request(method='POST',
            url=url,
            params=params,
            files={ 'classname_positive_examples': classname_positive_examples_tuple, 
            'negative_examples': negative_examples_tuple },
            accept_json=True)
        return response
...
class Class(object):
    ...
    def _from_dict(cls, _dict):
        ...
        if 'class' in _dict:
            ...
            raise ValueError('Required property \'class\' not present in Class JSON')
        return cls(**args)
...
class ClassResult(object):
    ...
    def _from_dict(cls, _dict):
        ...
        if 'class' in _dict:
            ...
            raise ValueError('Required property \'class\' not present in ClassResult JSON')
        if 'score' in _dict:
...
class ClassifiedImage(object):
    ...
    def __init__(self, classifiers, source_url=None, resolved_url=None, image=None, error=None):
        """
    ...
    def _from_dict(cls, _dict):
        ...
        if 'classifiers' in _dict:
            args['classifiers'] = [ClassifierResult._from_dict(x) for x in _dict['classifiers']]
        else:
            raise ValueError('Required property \'classifiers\' not present in ClassifiedImage JSON')
        return cls(**args)
...
class ClassifiedImages(object):
    ...
    def __init__(self, images, custom_classes=None, images_processed=None, warnings=None):
        """
    ...
    def _from_dict(cls, _dict):
        ...
        if 'images' in _dict:
            args['images'] = [ClassifiedImage._from_dict(x) for x in _dict['images']]
        else:
            raise ValueError('Required property \'images\' not present in ClassifiedImages JSON')
        if 'warnings' in _dict:
            args['warnings'] = [WarningInfo._from_dict(x) for x in _dict['warnings']]
        return cls(**args)
    ...
    def _to_dict(self):
        ...
        if hasattr(self, 'images_processed') and self.images_processed is not None:
...
class Classifier(object):
    ...
    def __init__(self, classifier_id, name, owner=None, status=None, explanation=None, created=None, classes=None, retrained=None):
        """
    ...
    def _from_dict(cls, _dict):
        ...
        if 'name' in _dict:
            ...
            raise ValueError('Required property \'name\' not present in Classifier JSON')
        if 'owner' in _dict:
...
class ClassifierResult(object):
    ...
    def _from_dict(cls, _dict):
        ...
        if 'name' in _dict:
            ...
            raise ValueError('Required property \'name\' not present in ClassifierResult JSON')
        if 'classifier_id' in _dict:
            args['classifier_id'] = _dict['classifier_id']
        else:
            raise ValueError('Required property \'classifier_id\' not present in ClassifierResult JSON')
        if 'classes' in _dict:
            args['classes'] = [ClassResult._from_dict(x) for x in _dict['classes']]
        else:
            raise ValueError('Required property \'classes\' not present in ClassifierResult JSON')
        return cls(**args)
...
class Classifiers(object):
    ...
    def _from_dict(cls, _dict):
        ...
        if 'classifiers' in _dict:
            ...
            raise ValueError('Required property \'classifiers\' not present in Classifiers JSON')
        return cls(**args)
...
class DetectedFaces(object):
    ...
    def _from_dict(cls, _dict):
        ...
        if 'images_processed' in _dict:
            args['images_processed'] = _dict['images_processed']
        if 'images' in _dict:
            args['images'] = [ImageWithFaces._from_dict(x) for x in _dict['images']]
        else:
            raise ValueError('Required property \'images\' not present in DetectedFaces JSON')
        if 'warnings' in _dict:
            args['warnings'] = [WarningInfo._from_dict(x) for x in _dict['warnings']]
        return cls(**args)
...
class ErrorInfo(object):
    ...
    def _from_dict(cls, _dict):
        ...
        if 'code' in _dict:
            ...
            raise ValueError('Required property \'code\' not present in ErrorInfo JSON')
        if 'description' in _dict:
            args['description'] = _dict['description']
        else:
            raise ValueError('Required property \'description\' not present in ErrorInfo JSON')
        if 'error_id' in _dict:
            args['error_id'] = _dict['error_id']
        else:
            raise ValueError('Required property \'error_id\' not present in ErrorInfo JSON')
        return cls(**args)
...
class Face(object):
    ...
    def __init__(self, age=None, gender=None, face_location=None, identity=None):
        """
    ...
    def _from_dict(cls, _dict):
        ...
        if 'face_location' in _dict:
            args['face_location'] = FaceLocation._from_dict(_dict['face_location'])
...
class FaceGender(object):
    ...
    def _from_dict(cls, _dict):
        ...
        if 'gender' in _dict:
            ...
            raise ValueError('Required property \'gender\' not present in FaceGender JSON')
        if 'score' in _dict:
            args['score'] = _dict['score']
        return cls(**args)
...
class FaceIdentity(object):
    ...
    def _from_dict(cls, _dict):
        ...
        if 'name' in _dict:
            ...
            raise ValueError('Required property \'name\' not present in FaceIdentity JSON')
        if 'score' in _dict:
            args['score'] = _dict['score']
        if 'type_hierarchy' in _dict:
            args['type_hierarchy'] = _dict['type_hierarchy']
...
class FaceLocation(object):
    ...
    def _from_dict(cls, _dict):
        ...
        if 'width' in _dict:
            ...
            raise ValueError('Required property \'width\' not present in FaceLocation JSON')
        if 'height' in _dict:
            args['height'] = _dict['height']
        else:
            raise ValueError('Required property \'height\' not present in FaceLocation JSON')
        if 'left' in _dict:
            args['left'] = _dict['left']
        else:
            raise ValueError('Required property \'left\' not present in FaceLocation JSON')
        if 'top' in _dict:
            args['top'] = _dict['top']
        else:
            raise ValueError('Required property \'top\' not present in FaceLocation JSON')
        return cls(**args)
...
class ImageWithFaces(object):
    ...
    def __init__(self, faces, image=None, source_url=None, resolved_url=None, error=None):
        """
    ...
    def _from_dict(cls, _dict):
        ...
        if 'faces' in _dict:
            ...
            raise ValueError('Required property \'faces\' not present in ImageWithFaces JSON')
        if 'image' in _dict:
            args['image'] = _dict['image']
        if 'source_url' in _dict:
            args['source_url'] = _dict['source_url']
...
class WarningInfo(object):
    ...
    def _from_dict(cls, _dict):
        ...
        if 'warning_id' in _dict:
            ...
            raise ValueError('Required property \'warning_id\' not present in WarningInfo JSON')
        if 'description' in _dict:
            args['description'] = _dict['description']
        else:
            raise ValueError('Required property \'description\' not present in WarningInfo JSON')
        return cls(**args)
